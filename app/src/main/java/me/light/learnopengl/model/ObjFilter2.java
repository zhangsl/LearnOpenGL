...
public class ObjFilter2 extends AFilter {
    ...
    protected void onCreate() {
        createProgramByAssetsFile("threedim/obj2.vert","threedim/obj2.frag");
        ...
        if(obj!=null){
            try {
                textureId=createTexture(BitmapFactory.decodeStream(mRes.getAssets().open("nanosuit/"+obj.mtl.map_Kd)));
